...
SAMPLES = [
    ("raw/21 - Clutch/21-01.jpg", "procedure", "Photos with numbered callouts + steps"),
    ("raw/21 - Clutch/21-07.jpg", "troubleshooting", "3-column Condition/Cause/Correction table"),
    ("raw/11 - Engine/11-50.jpg", "diagram", "Full-page engine cutaway illustration"),
    ("raw/00 - Torque Specs/00-01.jpg", "specification", "Data table with values/units"),
    ("raw/1990 BMW M3 Electrical Troubleshooting Manual/0670-01.jpg", "fuse_chart", "Fuse data chart"),
    ("raw/34 - Brakes/34-10.jpg", "procedure", "Photos with steps"),
]
